...
<div class="container-contact100" style="background-image: url('img/animal_reg.jpg');">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="user">
				<span class="contact100-form-title">
					<center> AnimalsDAR</center>
				</span>
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input type="email" name="email" id="inputEmail"
								class="input100" placeholder="Enter your email">
				</div>
			
				<div class="wrap-input100 rs1-wrap-input100 validate-input" >
					<span class="label-input100">Occupation *</span>
					<input class="input100" type="text" name="occupation" placeholder="Enter your Occupation">
				</div>
				<div class="wrap-input100 rs1-wrap-input100 validate-input" >
					<span class="label-input100">Interest*</span>
					<input class="input100" type="text" name="interest" placeholder="Enter your interest">
				</div>
				<div class="wrap-input100 rs1-wrap-input100 validate-input" >
					<span class="label-input100">Password *</span>
					<input class="input100" type="password" name="password" id="inputPassword"
										class="form-control" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" placeholder="Password (maj,min,number/char spec,8char)"
										required="required"> 
				</div>
