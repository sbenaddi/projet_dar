			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<a href="javascript:;" class="dropdown-toggle"
						...
						<img alt="" id="acceuilimgprofile" class="img-circle" src="" /> 
						<span id="acceuilusername" class="username username-hide-on-mobile"></span> <i
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				<iframe id="iframe"  frameborder="0" scrolling="no" width="100%" 
					height="800" src="annonce.jsp"></iframe>
