...
<body>
    ...
    <div class="blog-wrapper section-padding-100-0 clearfix">
        <div class="container">
                     <button style='margin-bottom:20px;' class='button' onclick='afficher_form()'> + evenement</button>
				<form id="new_event" action="event" method="POST"
					enctype="multipart/form-data" style="display:none;margin-bottom:20px;">
