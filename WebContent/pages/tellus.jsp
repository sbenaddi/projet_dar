	...
	<div class="portlet-body util-btn-margin-bottom-5">
		<div class="clearfix">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<textarea class="form-control maxlength-handler" id="description" maxlength="100" name="description" placeholder=""></textarea>
			...
			<input id="register" type="button" href="javascript:;" class="btn btn-lg green"
				value="Commenter" />
		</div>
	</div>
</div>
