						...
						<div class="row h-100 align-items-center">
							<div class="col-12">
								<div class="slide-content text-center">
									...
									<h2 data-animation="fadeInUp" data-delay="250ms">
										<a href="single-post.html">Sauvez les animaux qui sont notre éspoir!</a>
									</h2>
								</div>
							</div>
						</div>
						...
						<div class="row h-100 align-items-center">
							<div class="col-12">
								<div class="slide-content text-center">
									...
									<h2 data-animation="fadeInUp" data-delay="250ms">
										<a href="single-post.html">Les êtres qui ne déçoivent jamais</a>
									</h2>
								</div>
							</div>
						</div>
...
<button class='button' onclick="rechercher()">search</button>
							...
							<div class="sidebar-widget-area">
								...
								<a href="#"><img src="img/acce.gif" alt=""></a>
							</div>
								...
								<div class="widget-content">
									<ul class="tags">
										...
										<li><form id='a1'>
											...
											<a href="#" onclick="filtrer('a1')">chercher animal</a></li>
										<li><form id='a2'>
												<input type='hidden' name='action' value='filtrer'><input
													type='hidden' name='categorie' value='proposer animal'>
											</form>
											<a href="#" onclick="filtrer('a2')">proposer animal</a></li>
										<li><form id='a3'>
												<input type='hidden' name='action' value='filtrer'><input
													type='hidden' name='categorie'
													value='chercher garde animaux'>
											</form>
											<a href="#" onclick="filtrer('a3')">chercher garde
												animaux</a></li>
										<li><form id='a4'>
												<input type='hidden' name='action' value='filtrer'><input
													type='hidden' name='categorie' value='garder des animaux'>
											</form>
											<a href="#" onclick="filtrer('a4')">garder des animaux</a></li>
										<li><form id='a5'>
												<input type='hidden' name='action' value='filtrer'><input
													type='hidden' name='categorie' value='animaux perdus'>
											</form>
											<a href="#" onclick="filtrer('a5')">animaux perdus</a></li>
										<li><form id='a6'>
												<input type='hidden' name='action' value='filtrer'><input
													type='hidden' name='categorie' value='autre'>
											</form>
											<a href="#" onclick="filtrer('a6')">autre</a></li>
		...
		<div class="instagram-slides owl-carousel">
			...
			<div class="single-insta-feed">
				...
				<div class="hover-effects">
					<a href="https://www.instagram.com/animalia_officiel/"
	...
	<script src="../js/annoncet.js"></script>
