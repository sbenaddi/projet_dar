								...
								<div>
									...
									<div class="margin-top-20 profile-desc-link">
										<i class="fa fa-twitter"></i> <a
											href="http://www.twitter.com/keenthemes/"></a>
									</div>
											...
											<div class="tab-content">
												...
												<div class="tab-pane active" id="tab_1_1">
													<form role="form" action="user" methode="POST">
														...
														<div class="margiv-top-10">
															<a id="updateProfile" href="javascript:;" class="btn green-haze">  Save Changes</a> 
												...
												<div class="tab-pane" id="tab_1_2">
													<form action="#">
														...
														<div class="margin-top-10">
															<a id="changePassword" href="javascript:;" class="btn green-haze"> Changer le mot de passe </a> <a href="javascript:;" class="btn default">
																Cancel </a>
														</div>
													</form>
												...
												<div class="tab-pane" id="tab_1_3">
													<form id="changeAvatar-form"  action="upload" method="POST" enctype="multipart/form-data" >
													    ...
													    <div class="margin-top-10">
															<a id="changeAvatar" href="javascript:;" class="btn green-haze"> Submit </a>
														</div>
